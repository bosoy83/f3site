...
if($_POST)
{
	...
	#Dane
	$u=array(
	'gg'  =>is_numeric($_POST['x_gg']) ? (int)$_POST['x_gg'] : null,
	'tlen'=>Clean($_POST['x_tl'],30),
	'icq' =>is_numeric($_POST['x_icq']) ? (int)$_POST['x_icq'] : null,
	'www' =>$x_w,
	...
	else
	{
		...
		if(LOGD==2 && $cfg['actmeth']==2)
		{
			...
			if(SendTo($x_l,$x_m))
			{
				if($q->execute($u))
				{
					$content->info($lang['u bymail'].$x_l.'<br /><br />'.$lang['u nomail']);
