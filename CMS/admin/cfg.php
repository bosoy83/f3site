...
if($_POST)
{
	...
	$_POST['o']['c']=ctype_alpha($_POST['coo'])?$_POST['coo']:PRE; //Nazwa cookie
...
<tr>
	...
	<td><input name="coo" value="'.PRE.'" /></td>
</tr>
<tr>
...
<tr>
	<td><b>'.$lang['pspdr'].':</b><div class="txtm">Katalog: mod/polls/</div></td>
	<td><select name="o[pollr1]">'.ListBox('mod/polls',2,$cfg['pollr1']).'</select></td>
</tr>
<tr>
	<td><b>'.$lang['pspdr'].' 2:</b><div class="txtm">'.$lang['inblock'].'</div></td>
	<td><select name="o[pollr2]">'.ListBox('mod/polls',2,$cfg['pollr2']).'</select></td>
</tr>
