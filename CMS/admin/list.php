...
if(Admit('DEL')) { $del=1; } else { $del=2; }
require(LANG_DIR.'adm_z.php');

#Typ
switch($co)
{
 case 5: if(!Admit('N')) { exit; } $xtype=&$lang['news']; $xadd=&$lang['addnews']; $xco='new'; $xinfo=&$lang['ap_ninfo']; break;
 case 4: if(!Admit('L')) { exit; } $xtype=&$lang['links']; $xadd=&$lang['addlink']; $xco='link'; $xinfo=&$lang['ap_linfo']; break;
 case 3: if(!Admit('G')) { exit; } $xtype=&$lang['images']; $xadd=&$lang['addimg']; $xco='img'; $xinfo=&$lang['ap_iinfo']; break;
 case 2: if(!Admit('F')) { exit; } $xtype=&$lang['files']; $xadd=&$lang['addfile']; $xco='file'; $xinfo=&$lang['ap_finfo']; break;
 default: if(!Admit('A')) { exit; } $xtype=&$lang['arts']; $xadd=&$lang['addart']; $xco='art'; $co=1; $xinfo=&$lang['ap_artinfo'];
}
...
#Szukaj
$find=($_GET['find'] && strlen($_GET['find'])<30)? Clean($_GET['find'],1,1,0) : '';
