...
for($i=0;$i<$ile;$i++) { $ii=$i+1;
 ...
 <tr>
  ...
  <td>'.$lang['txt'].':<br /><input maxlength="10" value="'.$emodata[$i][2].'" name="eetxt['.$i.']" style="width: 70px" /></td>
  <td>'.$lang['file'].':<br /><select id="eeadr'.$i.'" name="eeadr'.$i.'" onchange="Pr('.$i.')">';
	for($y=0;$y<$ilep;$y++)
	{
...
echo '
 ...
 <center>
 <a href="javascript:Dodaj()">'.$lang['addemo'].'</a>
 </center>
 </td>
</tr>
<tr>
