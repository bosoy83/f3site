...
#Szablony
define('STYLE_DIR',  './cache/'.$nstyl.'/');
define('HTML_DIR', './style/'.$nstyl.'/');
...
function genDate($x)
{
	...
	{
		$d=str_replace('%d',$e[2],$GLOBALS['cfg']['fdate1']);
	...
	{
		$g=explode(':',$f[1]);
		$d.=str_replace('%h',$g[0],$GLOBALS['cfg']['fdate2']);
