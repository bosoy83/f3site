...
#Odczyt
$img=array();
$ile=db_read('ID,name,date,filem','imgs','img','ta',' WHERE '.((defined('SEARCH'))?SEARCH:'access=1 && cat='.$dinfo['ID'].' ORDER BY priority, '.$hlsort).' LIMIT '.$st.','.$cfg['inp']);
